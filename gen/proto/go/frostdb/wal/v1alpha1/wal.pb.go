...
type Entry struct {
	...
	//	*Entry_Snapshot_
	//	*Entry_TransactionWrite_
	//	*Entry_TransactionAborted_
...
func (x *Entry) GetTransactionWrite() *Entry_TransactionWrite {
	if x, ok := x.GetEntryType().(*Entry_TransactionWrite_); ok {
		return x.TransactionWrite
	}
	return nil
}

func (x *Entry) GetTransactionAborted() *Entry_TransactionAborted {
	if x, ok := x.GetEntryType().(*Entry_TransactionAborted_); ok {
...
type Entry_TransactionWrite_ struct {
	// TransactionWrite is set if the entry describes a transaction-write.
	TransactionWrite *Entry_TransactionWrite `protobuf:"bytes,5,opt,name=transaction_write,json=transactionWrite,proto3,oneof"`
}

type Entry_TransactionAborted_ struct {
	// TransactionAborted is set if the entry describes a transaction-aborted.
	TransactionAborted *Entry_TransactionAborted `protobuf:"bytes,6,opt,name=transaction_aborted,json=transactionAborted,proto3,oneof"`
}
...
func (*Entry_TransactionWrite_) isEntry_EntryType() {}

func (*Entry_TransactionAborted_) isEntry_EntryType() {}
...
type Entry_TransactionWrite struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The writes of the transaction, in insertion order.
	Writes []*Entry_Write `protobuf:"bytes,1,rep,name=writes,proto3" json:"writes,omitempty"`
}

func (x *Entry_TransactionWrite) Reset() {
	*x = Entry_TransactionWrite{}
	if protoimpl.UnsafeEnabled {
...
func (x *Entry_TransactionWrite) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Entry_TransactionWrite) ProtoMessage() {}

func (x *Entry_TransactionWrite) ProtoReflect() protoreflect.Message {
	mi := &file_frostdb_wal_v1alpha1_wal_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Entry_TransactionWrite.ProtoReflect.Descriptor instead.
func (*Entry_TransactionWrite) Descriptor() ([]byte, []int) {
	return file_frostdb_wal_v1alpha1_wal_proto_rawDescGZIP(), []int{1, 4}
}

func (x *Entry_TransactionWrite) GetWrites() []*Entry_Write {
	if x != nil {
		return x.Writes
	}
	return nil
...
type Entry_TransactionAborted struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Entry_TransactionAborted) Reset() {
	*x = Entry_TransactionAborted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_frostdb_wal_v1alpha1_wal_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Entry_TransactionAborted) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Entry_TransactionAborted) ProtoMessage() {}

func (x *Entry_TransactionAborted) ProtoReflect() protoreflect.Message {
	mi := &file_frostdb_wal_v1alpha1_wal_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Entry_TransactionAborted.ProtoReflect.Descriptor instead.
func (*Entry_TransactionAborted) Descriptor() ([]byte, []int) {
	return file_frostdb_wal_v1alpha1_wal_proto_rawDescGZIP(), []int{1, 5}
}
...
var file_frostdb_wal_v1alpha1_wal_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xe2,
	...
	,
	...
	0x1a, 0x4d, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x57,
	0x72, 0x69, 0x74, 0x65, 0x12, 0x39, 0x0a, 0x06, 0x77, 0x72, 0x69, 0x74, 0x65, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x66, 0x72, 0x6f, 0x73, 0x74, 0x64, 0x62, 0x2e, 0x77,
	0x61, 0x6c, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x2e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x52, 0x06, 0x77, 0x72, 0x69, 0x74, 0x65, 0x73, 0x1a,
	0x14, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x62,
	0x6f, 0x72, 0x74, 0x65, 0x64, 0x42, 0x0c, 0x0a, 0x0a, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x5f, 0x74,
...
var file_frostdb_wal_v1alpha1_wal_proto_goTypes = []any{
	...
	(*Entry_TransactionWrite)(nil),    // 6: frostdb.wal.v1alpha1.Entry.TransactionWrite
	(*Entry_TransactionAborted)(nil),  // 7: frostdb.wal.v1alpha1.Entry.TransactionAborted
...
var file_frostdb_wal_v1alpha1_wal_proto_depIdxs = []int32{
	...
	6, // 5: frostdb.wal.v1alpha1.Entry.transaction_write:type_name -> frostdb.wal.v1alpha1.Entry.TransactionWrite
	7, // 6: frostdb.wal.v1alpha1.Entry.transaction_aborted:type_name -> frostdb.wal.v1alpha1.Entry.TransactionAborted
	8, // 7: frostdb.wal.v1alpha1.Entry.NewTableBlock.config:type_name -> frostdb.table.v1alpha1.TableConfig
	2, // 8: frostdb.wal.v1alpha1.Entry.TransactionWrite.writes:type_name -> frostdb.wal.v1alpha1.Entry.Write
...
func file_frostdb_wal_v1alpha1_wal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_frostdb_wal_v1alpha1_wal_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Entry_TransactionWrite); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_frostdb_wal_v1alpha1_wal_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Entry_TransactionAborted); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_frostdb_wal_v1alpha1_wal_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*Entry_Snapshot_)(nil),
		(*Entry_TransactionWrite_)(nil),
		(*Entry_TransactionAborted_)(nil),
	}
	type x struct{}
